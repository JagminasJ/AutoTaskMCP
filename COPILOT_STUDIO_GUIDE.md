...
- getTicketsByDate: Use this when user asks for "tickets created today", "tickets created yesterday", "tickets created on Wednesday", "tickets created on 2025-01-15", or any date. This tool automatically parses natural language date descriptions (today, yesterday, day names, specific dates, relative dates), filters by createDate, looks up company names and contact names (sender), and returns only the requested fields. Use fields parameter to specify which fields to return (e.g., ["companyName", "ticketNumber", "sender", "description"]). Returns actual ticket details, NOT a count. DO NOT use ticketsQueryCount.
...
| "Tickets created today/yesterday/Wednesday/date" | getTicketsByDate | Use getTicketsByDate with date parameter (e.g., "today", "yesterday", "Wednesday", "2025-01-15") and fields parameter to specify which fields to return (e.g., ["companyName", "ticketNumber", "sender", "description"]). Returns actual ticket details, NOT a count. |
